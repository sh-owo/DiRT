...
class ProposeBlock(nn.Module):
    ...
    def __call__(
        ...
        q = self.q_proj(z_L_norm).reshape(batch, seq_len, self.cfg.n_heads, head_dim)
        ...
        swiglu_out = swiglu(ffn_norm, self.gate_proj, self.up_proj, self.down_proj)
